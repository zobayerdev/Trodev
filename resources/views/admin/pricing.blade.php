...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{asset('admin/assets/libs/jquery-minicolors/jquery.minicolors.css')}}">
    <link rel="stylesheet" type="text/css"
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav" class="p-t-30">
                    <li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark sidebar-link"
                                                href="{{route('admin.dashboard',['id'=>$id->id])}}"
                    ...
                    <li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark sidebar-link"
                                                href="{{route('service',['id'=>$id->id])}}" aria-expanded="false"><i
                                class="mdi mdi-border-inside"></i><span class="hide-menu">Offer Service</span></a></li>
                    <li class="sidebar-item"><a class="sidebar-link has-arrow waves-effect waves-dark"
                                                href="javascript:void(0)" aria-expanded="false"><i
                                class="mdi mdi-nature-people"></i><span class="hide-menu">Blog</span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item"><a href="{{route('blog',['id'=>$id->id])}}" class="sidebar-link"><i
                                        class="mdi mdi-plus"></i><span class="hide-menu"> Write Blog </span></a></li>
                            <li class="sidebar-item"><a href="{{route('editblog',['id'=>$id->id])}}"
                                                        class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
                    ...
                    <li class="sidebar-item"><a class="sidebar-link has-arrow waves-effect waves-dark"
                                                href="javascript:void(0)" aria-expanded="false"><i
                                class="mdi mdi-nature-people"></i><span class="hide-menu">Pricing</span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
<<<<<<< HEAD
                            <li class="sidebar-item"><a href="" class="sidebar-link"><i class="mdi mdi-plus"></i><span
                                        class="hide-menu"> Add Pricing </span></a></li>
                            <li class="sidebar-item"><a href="{{route('editprice',['id'=>$id->id])}}"
                                                        class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
                                        class="hide-menu"> Price List </span></a></li>
=======
...
>>>>>>> 8c4cfb4a79d80aa829f13d89ca3ea30a7ce1e7da
                        </ul>
                    </li>
                    <li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark sidebar-link"
                    ...
                    <li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark sidebar-link"
                                                href="{{route('visitor',['id'=>$id->id])}}" aria-expanded="false"><i
                                class="mdi mdi-blur-linear"></i><span class="hide-menu">Visitor IPs</span></a></li>
                    <li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark sidebar-link"
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <form class="form-horizontal" action="{{route('packageinsert')}}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="select2 form-control custom-select" name="details"
                                                id="typeSelect" style="width: 100%; height:36px;" required>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 text-right control-label col-form-label">Maintenance
                                        Charge</label>
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" name="maintenance" id="durationSelect"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email1" class="col-sm-3 text-right control-label col-form-label">Storage
                                        Charge</label>
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" name="storage" id="monthlycharge"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" name="percentage" id="sslcertificate"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="development" id="training"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="imageUpload" class="col-sm-3 text-right control-label col-form-label">UI/UX
                                        Design</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="ui/ux" id="revision"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="imageUpload" class="col-sm-3 text-right control-label col-form-label">Logo
                                        Design</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="logo" id="domains"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="imageUpload" class="col-sm-3 text-right control-label col-form-label">Design
                                        Issue</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="card" id="storageSelect"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="imageUpload" class="col-sm-3 text-right control-label col-form-label">Training
                                        Time</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="training" id="storageSelect"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="imageUpload" class="col-sm-3 text-right control-label col-form-label">Revision
                                        Period</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="revision" id="storageSelect"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="imageUpload" class="col-sm-3 text-right control-label col-form-label">Project
                                        Manager</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="manager" id="storageSelect"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="imageUpload" class="col-sm-3 text-right control-label col-form-label">Edit
                                        Request</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="edit" id="storageSelect"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="imageUpload" class="col-sm-3 text-right control-label col-form-label">Technical
                                        Planning</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="planning" id="storageSelect"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="imageUpload" class="col-sm-3 text-right control-label col-form-label">Development
                                        Request</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="request" id="storageSelect"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="security" id="storageSelect"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="imageUpload" class="col-sm-3 text-right control-label col-form-label">Administration
                                        Setup</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="setup" id="storageSelect"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="imageUpload" class="col-sm-3 text-right control-label col-form-label">Quality
                                        Assurance</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="sqa" id="storageSelect"
                                               style="width: 100%; height:36px;" required>
                                    </div>
                                </div>
