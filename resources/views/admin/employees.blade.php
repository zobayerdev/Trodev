        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav" class="p-t-30">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Employee</span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            ...
                            <li class="sidebar-item"><a href="" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu"> Employee List </span></a></li>
                        </ul>
                    </li>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="el-card-item">
                                <div class="el-card-avatar el-overlay-1"> <img src="{{asset('storage/' .$proj->pic)}}" alt="user"/>
                                    <div class="el-overlay">
                                        <ul class="list-style-none el-info">
                                            <li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="{{asset('storage/' .$proj->pic)}}"><i class="mdi mdi-magnify-plus"></i></a></li>
                                            <li class="el-item"><a class="btn default btn-outline el-link" href="{{route('editemployee',['id'=>$id->id,'project'=>$proj->id])}}"><i class="mdi mdi-link"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="el-card-content">
                                    <h4 class="m-b-0">{{$proj->Name}}</h4> <span class="text-muted">{{$proj->Designation}}</span>
                                    <span class="text-muted">{{$proj->Dapartment}}</span><br>
                                    <span class="text-muted">Completed: {{$proj->Complete_Project}}</span><br>
                                    <span class="text-muted">{{$proj->email}}</span><br>
                                    <span class="text-muted">{{$proj->phone}}</span><br>
                                </div>
                            </div>
                        </div>
                    </div>
