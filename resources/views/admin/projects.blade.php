...
<head>
    ...
    <title>Projects List (Trodev)</title>
    <!-- Custom CSS -->
                ...
                <ul id="sidebarnav" class="p-t-30">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Project</span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            ...
                            <li class="sidebar-item"><a href="" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu"> Project List </span></a></li>
                        </ul>
                    </li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card">
                        <div class="el-card-item">
                            <div class="el-card-avatar el-overlay-1"> <img src="{{asset('storage/' .$proj->image)}}" alt="user"/>
                                <div class="el-overlay">
                                    <ul class="list-style-none el-info">
                                        <li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="{{asset('storage/' .$proj->image)}}"><i class="mdi mdi-magnify-plus"></i></a></li>
                                        <li class="el-item"><a class="btn default btn-outline el-link" href="{{route('editproject',['id'=>$id->id,'project'=>$proj->id])}}"><i class="mdi mdi-link"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="el-card-content">
                                <h4 class="m-b-0">{{$proj->name}}</h4> <span class="text-muted">{{$proj->description}}</span>
                                <span class="text-muted">{{$proj->price}}</span><br>
                                <span class="text-muted">{{$proj->url}}</span><br>
                                <span class="text-muted">{{$proj->mode}}</span><br>
                                <span class="text-muted">{{$proj->type}}</span><br>
                            </div>
                        </div>
                    </div>
                </div>
