...
<head>
    ...
    <title>Edit Projects Info</title>
    <!-- Custom CSS -->
                ...
                <ul id="sidebarnav" class="p-t-30">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Project</span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item"><a href="" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu"> Add Project </span></a></li>
                        ...
                        <form class="form-horizontal" action="{{route('edit')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="lname" name="description" value="{{$project->description}}" placeholder="Description Here">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="lname" class="col-sm-3 text-right control-label col-form-label">Price</label>
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" id="lname" name="price" value="{{$project->price}}" placeholder="Price Here">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email1" class="col-sm-3 text-right control-label col-form-label">Demon Link</label>
                                    <div class="col-sm-9">
                                        <input type="url" class="form-control" id="email1" name="url" value="{{$project->url}}" placeholder="Demo Link Here">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 text-right control-label col-form-label">Mode</label>
                                    <div class="col-md-9">
                                        <select class="select2 form-control custom-select" name="mode" style="width: 100%; height:36px;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <img src="{{asset('storage/'.$project->image)}}" width="50%" height="100%">
