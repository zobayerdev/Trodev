        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 col-xlg-3">
                    ...
                    <a href="{{route('project',['id'=>$id->id])}}" class="card card-hover">
                        <div class="box bg-success text-center">
                            <h1 class="font-light text-white"><i class="mdi mdi-chart-areaspline"></i></h1>
                            <h6 class="text-white">Add Project</h6>
                        </div>
                    </a>
                </div>
                <!-- Column -->
                <div class="col-md-6 col-lg-2 col-xlg-3">
                    <a href="{{route('employee',['id'=>$id->id])}}" class="card card-hover">
                ...
                <!-- Column -->
                <div class="col-md-6 col-lg-2 col-xlg-3">
                    <a href="{{route('service',['id'=>$id->id])}}" class="card card-hover">
                        <div class="box bg-danger text-center">
                            <h1 class="font-light text-white"><i class="mdi mdi-border-outside"></i></h1>
                            <h6 class="text-white">Offer Service</h6>
                        </div>
                    </a>
                </div>
                <!-- Column -->
                <div class="col-md-6 col-lg-2 col-xlg-3">
                    <a href="{{route('blog',['id'=>$id->id])}}" class="card card-hover">
                ...
                <div class="col-md-6 col-lg-4 col-xlg-3">
                    <a href="{{route('clientlist',['id'=>$id->id])}}" class="card card-hover">
                        <div class="box bg-danger text-center">
                            ...
                            <h6 class="text-white">Client List</h6>
                        </div>
                    </a>
                </div>
                <!-- Column -->
                ...
                <!-- Column -->
                <div class="col-md-6 col-lg-2 col-xlg-3">
                    <a href="{{route('calender',['id'=>$id->id])}}" class="card card-hover">
                        <div class="box bg-success text-center">
