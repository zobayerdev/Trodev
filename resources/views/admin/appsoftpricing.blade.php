                ...
                <ul id="sidebarnav" class="p-t-30">
                    ...
                    <li class="sidebar-item"><a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-nature-people"></i><span class="hide-menu">Pricing</span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            ...
                            <li class="sidebar-item"><a href="" class="sidebar-link"><i class="mdi mdi-plus"></i><span class="hide-menu"> App&Software Pricing </span></a></li>
                            <li class="sidebar-item"><a href="{{route('packages',['id'=>$id->id])}}" class="sidebar-link"><i class="mdi mdi-plus"></i><span class="hide-menu"> UI/UX&Graphic Design Pricing </span></a></li>
                    ...
                    <div class="card">
                        <form class="form-horizontal" action="{{route('packageinsert')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="imageUpload" class="col-sm-3 text-right control-label col-form-label">Training Test</label>
                                    <div class="col-md-9">
