    ...
    <div class="container d-flex align-items-center">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item"><a href="{{route('graphicdesignhomepage')}}" class="nav-link">Home</a></li>
...
{{--                <li class="nav-item"><a href="{{route('blogs')}}" class="nav-link">Blog</a></li>--}}
                <li class="nav-item  active"><a href="{{route('graphicdesignpricing')}}" class="nav-link">Pricing</a></li>
