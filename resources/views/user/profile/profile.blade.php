        ...
        <div class="col-md-12">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                <label for="profilePicInput">
                    <img class="rounded-circle mt-5" width="150px" src="{{asset('storage/'.$id->propic)}}" id="profilePicPreview"><br>
                    <span class="font-weight-bold">{{$id->name}}</span>
                    <span class="text-black-50">{{$id->email}}</span>
                </label>
                <input type="file" id="profilePicInput" name="propic" style="display: none;" onchange="previewProfilePic(this)">
            </div>
        </div>
        <div class="col-md-12">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-12"><label class="labels">Name</label><input type="text" class="form-control" name="name" placeholder="Name" value="{{$id->name}}"></div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">Mobile Number</label><input type="text" class="form-control" name="phone" placeholder="Mobile Number" value="{{$id->mobile}}"></div>
                    <div class="col-md-12"><label class="labels">Address Line 1</label><input type="text" class="form-control" name="address1" placeholder="Address Line 1" value="{{$id->address1}}"></div>
                    <div class="col-md-12"><label class="labels">Address Line 2</label><input type="text" class="form-control" name="address2" placeholder="Address Line 2" value="{{$id->address2}}"></div>
                    <div class="col-md-12"><label class="labels">Secondary Email ID</label><input type="text" class="form-control" name="email" placeholder="Secondary Email ID" value="{{$id->second_email}}"></div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-6"><label class="labels">State/Region/Division/City</label><input type="text" name="state" class="form-control" placeholder="State/Region/Division/City" value="{{$id->state}}"></div>
                    <div class="col-md-6"><label class="labels">Country</label><input type="text" class="form-control" name="country" value="{{$id->country}}" placeholder="Country"></div>
                </div>
...
<script>
    function previewProfilePic(input) {
        ...
        if (file) {
            ...
            preview.src = "{{asset('storage/'.$id->propic)}}";
        }
    }
</script>
</body>
