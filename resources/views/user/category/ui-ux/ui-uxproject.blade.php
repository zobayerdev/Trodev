    ...
    <div class="container d-flex align-items-center">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item"><a href="{{route('uiuxhomepages',['id'=>$id->id])}}" class="nav-link">Home</a></li>
{{--                <li class="nav-item"><a href="{{route('about')}}" class="nav-link">About</a></li>--}}
                <li class="nav-item"><a href="{{route('uiuxservices',['id'=>$id->id])}}" class="nav-link">Services</a></li>
                <li class="nav-item active"><a href="{{route('uiuxprojects',['id'=>$id->id])}}" class="nav-link">Projects</a></li>
{{--                <li class="nav-item"><a href="{{route('blogs')}}" class="nav-link">Blog</a></li>--}}
                <li class="nav-item"><a href="{{route('uiuxpricings',['id'=>$id->id])}}" class="nav-link">Pricing</a></li>
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs"><span class="mr-2"><a href="{{route('homepage',['id'=>$id->id])}}">Home <i class="fa fa-chevron-right"></i></a></span> <span>Projects <i class="fa fa-chevron-right"></i></span></p>
                ...
                <div class="col-md-4">
                    <a href="{{route('singlepages',['id'=>$projects->id,'user'=>$id->id])}}">
                        <div class="project">
                            ...
                            <div class="text">
                                <a href="{{route('singlepages',['id'=>$projects->id,'user'=>$id->id])}}"><span class="subheading">{{$projects->type}}</span></a>
                                <a href="{{route('singlepages',['id'=>$projects->id,'user'=>$id->id])}}"><h3>{{$projects->name}}</h3></a>
