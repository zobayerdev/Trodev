...
{{--                <li class="nav-item"><a href="{{route('about')}}" class="nav-link">About</a></li>--}}
                ...
                <li class="nav-item"><a href="{{route('uiuxprojects',['id'=>$id->id])}}" class="nav-link">Projects</a></li>
{{--                <li class="nav-item"><a href="{{route('blogs')}}" class="nav-link">Blog</a></li>--}}
                <li class="nav-item  active"><a href="{{route('uiuxpricings',['id'=>$id->id])}}" class="nav-link">Pricing</a></li>
                    ...
                    @if($servicec->services === 'Basic')
                        <div class="services-wrap ftco-animate custom-card-size">
                            <div class="text" style="color: black; text-align: left">
                                ...
                                <p>Landing/System Design Page:- <strong>{{$servicec->service}} pages</strong></p>
