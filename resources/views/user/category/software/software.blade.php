    ...
    <div class="container d-flex align-items-center">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active"><a href="{{route('softwarehompages',['id'=>$id->id])}}" class="nav-link">Home</a></li>
{{--                <li class="nav-item"><a href="{{route('about')}}" class="nav-link">About</a></li>--}}
                <li class="nav-item"><a href="{{route('softwaresservices',['id'=>$id->id])}}" class="nav-link">Services</a></li>
                <li class="nav-item"><a href="{{route('softwareprojects',['id'=>$id->id])}}" class="nav-link">Projects</a></li>
{{--                <li class="nav-item"><a href="{{route('blogs')}}" class="nav-link">Blog</a></li>--}}
                <li class="nav-item"><a href="{{route('softwarepricings',['id'=>$id->id])}}" class="nav-link">Pricing</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 text-center">
                <div class="img" style="background-image: url({{asset('user/images/bg_2.png')}});">
                    <div class="overlay"></div>
                    <h1 style="color: white; font-weight: bolder;">Types Of Software Development We Offer</h1>
                    <p>We also offer specific task based digital marketing service as listed below</p>
                    <p class="mb-0">
                    <p class="btn btn-primary" style="font-size: 20px;">Inventory<br>Software</p>
                    <p class="btn btn-primary" style="font-size: 20px;">POS<br>Software</p>
                    <p class="btn btn-primary" style="font-size: 20px;">Management<br>Software</p>
                    </p>
    ...
    <div class="container">
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
                <img src="{{asset('category/apps/c_sharp.jpeg')}}">
            </div>

            <div class="mySlides fade">
                <img src="{{asset('category/apps/sql_server.png')}}">
            </div>
            <div class="mySlides fade">
                <img src="{{asset('category/apps/vs_code.jpeg')}}">
            </div>
