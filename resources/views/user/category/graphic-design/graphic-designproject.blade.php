...
{{--                <li class="nav-item"><a href="{{route('about')}}" class="nav-link">About</a></li>--}}
                ...
                <li class="nav-item active"><a href="{{route('graphicdesignprojects',['id'=>$id->id])}}" class="nav-link">Projects</a></li>
{{--                <li class="nav-item"><a href="{{route('blogs')}}" class="nav-link">Blog</a></li>--}}
                <li class="nav-item"><a href="{{route('graphicdesignpricings',['id'=>$id->id])}}" class="nav-link">Pricing</a></li>
