    ...
    <div class="container d-flex align-items-center">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item"><a href="{{route('graphicdesignhomepages',['id'=>$id->id])}}" class="nav-link">Home</a></li>
{{--                <li class="nav-item"><a href="{{route('about')}}" class="nav-link">About</a></li>--}}
                <li class="nav-item"><a href="{{route('graphicdesignservices',['id'=>$id->id])}}" class="nav-link">Services</a></li>
                <li class="nav-item"><a href="{{route('graphicdesignprojects',['id'=>$id->id])}}" class="nav-link">Projects</a></li>
{{--                <li class="nav-item"><a href="{{route('blogs')}}" class="nav-link">Blog</a></li>--}}
                <li class="nav-item  active"><a href="{{route('graphicdesignpricings',['id'=>$id->id])}}" class="nav-link">Pricing</a></li>
