    ...
    <div class="container d-flex align-items-center">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active"><a href="{{route('app',['id'=>$id->id])}}" class="nav-link">Home</a></li>
{{--                <li class="nav-item"><a href="{{route('about')}}" class="nav-link">About</a></li>--}}
                <li class="nav-item"><a href="{{route('appsservices',['id'=>$id->id])}}" class="nav-link">Services</a></li>
                <li class="nav-item"><a href="{{route('appprojects',['id'=>$id->id])}}" class="nav-link">Projects</a></li>
{{--                <li class="nav-item"><a href="{{route('blogs')}}" class="nav-link">Blog</a></li>--}}
                <li class="nav-item"><a href="{{route('apppricings',['id'=>$id->id])}}" class="nav-link">Pricing</a></li>
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
            <div class="col-lg-6 ftco-animate">
                <div class="mt-5">
                    ...
                    <p><a href="{{route('appsservices',['id'=>$id->id])}}" class="btn btn-primary">Our Services</a> <a href="#" class="btn btn-white">Touch Us</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
                <img src="{{asset('category/apps/android.png')}}">
            </div>

            <div class="mySlides fade">
                <img src="{{asset('category/apps/android_studio.png')}}">
            </div>

            <div class="mySlides fade">
                <img src="{{asset('category/apps/dart.jpg')}}">
            </div>
            ...
            <div class="mySlides fade">
                <img src="{{asset('category/apps/firebase.png')}}">
            </div>
