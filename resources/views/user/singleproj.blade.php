    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-7 d-flex topper align-items-center text-lg-right justify-content-end">
                <p class="mb-0 register-link"><a href="{{route('profile',['id'=>$id->id])}}" class="btn btn-primary">{{$user->name}}</a></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row d-flex align-items-start align-items-center px-3 px-md-0">
            <div class="col-md-4 d-flex mb-2 mb-md-0">
                <a class="navbar-brand d-flex align-items-center" href="{{route('homepage',['id'=>$user->id])}}">
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs"><span class="mr-2"><a href="{{route('homepage',['id'=>$user->id])}}">Home <i class="fa fa-chevron-right"></i></a></span> <span class="mr-2"><a href="#">Project <i class="fa fa-chevron-right"></i></a></span> <span>Project Single <i class="fa fa-chevron-right"></i></span></p>
                                        ...
                                        <div class="services-wrap ftco-animate custom-card-size">
                                            <div class="text">
                                                ...
                                                <div class="card-bottom">
                                                    <a href="https://cal.com/trodev/meeting" target=_blank class="btn-custom" style="text-align: center">Book a Meeting</a>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
            ...
            <div class="col-lg col-md-6">
                <div class="ftco-footer-widget">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{route('homepage',['id'=>$user->id])}}"><span class="fa fa-chevron-right mr-2"></span>Home</a></li>
                        <li><a href="{{route('aboutus',['id'=>$user->id])}}"><span class="fa fa-chevron-right mr-2"></span>About</a></li>
                        <li><a href="{{route('servicepages',['id'=>$user->id])}}"><span class="fa fa-chevron-right mr-2"></span>Services</a></li>
                        <li><a href="{{route('blogspages',['id'=>$user->id])}}"><span class="fa fa-chevron-right mr-2"></span>Blogs</a></li>
                        <li><a href="{{route('conatactpage',['id'=>$user->id])}}"><span class="fa fa-chevron-right mr-2"></span>Contact Us</a></li>
                    </ul>
                </div>
            </div>
